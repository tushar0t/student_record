...
public:
    ...
    float marks10;
    float marks12;
    string scholarType; // "Day Scholar" or "Hostler"
    string additionalInfo; // Address for Day Scholars or Hostel Name for Hostlers
    string hostelRoom; // Hostel Room Number for Hostlers
    Student* next;
...
// Define the StudentList class for managing the linked list
class StudentList {
private:
    Student* head;
